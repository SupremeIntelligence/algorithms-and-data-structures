...
**Примечание:**  
Код использует **DSU (Disjoint Set Union)** для объединения всех переменных по равенствам, а затем проверяет каждое неравенство — если обе переменные уже в одном множестве, система противоречива.